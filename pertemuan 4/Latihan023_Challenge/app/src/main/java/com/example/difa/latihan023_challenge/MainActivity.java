...
import
        com.example.difa.latihan023_challenge.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
            ...
            registerForActivityResult(new
                    ...
                    result -> {
                        if (result.getResultCode() == RESULT_OK) {
                            ...
                            String item =
                                    intent.getStringExtra(ShoppingListActivity.ITEM_TAG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding.btnSearchLoc.setOnClickListener(v -> {
            String loc =
                    mainBinding.editTextSearchLocation.getText().toString();
        ...
        if (savedInstanceState != null) {
            ...
            mainBinding.addItem.setEnabled(savedInstanceState.getBoolean("addItem disable d"));
        }
    }
}